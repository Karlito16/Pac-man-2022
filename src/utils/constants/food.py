...
FOOD_COIN_RELEVANT_SIZE_PERCENTAGE = PacmanConstant(0.25)     # relative from node size
FOOD_SUPER_COIN_RELEVANT_SIZE_PERCENTAGE = PacmanConstant(0.65)      # relative from node size
